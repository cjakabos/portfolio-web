...
```
- Common services: `test-backend`, `test-backend-petstore`, `test-backend-vehicles`, `test-backend-webproxy`, `test-ml-pipeline`, `test-nginx-gateway`, `test-frontend-unit`, `test-e2e`.
