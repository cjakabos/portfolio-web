...
const Home: React.FC = () => {
  ...
  const cards = [
    { title: 'Jira', desc: 'Project & Issue Tracking', icon: <Trello className="text-blue-600" size={32} />, path: '/jira', color: 'bg-blue-600/10' },
    ...
    { title: 'MLOps', desc: 'Customer Segmentation Model', icon: <Brain className="text-pink-500" size={32} />, path: '/mlops', color: 'bg-pink-500/10' },
    { title: 'GPT', desc: 'Local AI Assistant', icon: <Bot className="text-teal-500" size={32} />, path: '/chatllm', color: 'bg-teal-500/10' },
    { title: 'PetStore', desc: 'Manage your pet business', icon: <Cat className="text-indigo-500" size={32} />, path: '/petstore', color: 'bg-indigo-500/10', full: true },
  ];
          ...
          >
            <div className="flex items-start justify-between">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition">{card.title}</h3>
        ...
        <div className="space-y-4">
           {filteredActivities.length === 0 ? (
             ...
             filteredActivities.map(act => (
                <div key={act.id} className="flex items-center gap-4 pb-3 border-b border-gray-100 dark:border-gray-700 last:border-0 last:pb-0">
